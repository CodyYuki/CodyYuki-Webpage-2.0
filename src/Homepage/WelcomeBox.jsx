...
function WelcomeBox() {
  return (
    <div className="box" style={{border: "1px solid red", backgroundColor: "#373a40", width: "700px", height: "350px", margin: "500px 850px 0px"}}>
      <h1 className="title">Welcome to the Iclyn Settlement!</h1>
      <p className="desc"> We are part of the arctic rabbits clan years ago, <br></br>
      but after monsters attacked and destroied our outpost in the cold tundra, <br></br>
